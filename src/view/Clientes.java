...
public class Clientes extends JDialog {
	...
	public Clientes() {
		...
		lblNewLabel.setBounds(348, 54, 117, 36);
		getContentPane().add(lblNewLabel);

		lblNewLabel_1 = new JLabel("ntes");
		lblNewLabel_1.setFont(new Font("Arial Black", Font.ITALIC, 25));
		lblNewLabel_1.setBounds(402, 62, 131, 20);
		getContentPane().add(lblNewLabel_1);

		JLabel lblNewLabel_2 = new JLabel("Pesquisar Nome");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_2.setBounds(10, 107, 155, 25);
		getContentPane().add(lblNewLabel_2);

		txtId = new JTextField();
		txtId.setEditable(false);
		txtId.setColumns(10);
		txtId.setBounds(92, 160, 206, 27);
		...
		btnNewButton.setBounds(761, 368, 117, 124);
		...
		desktopPane.setBounds(426, 89, 432, 93);
		getContentPane().add(desktopPane);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 11, 412, 76);
		...
		lblNewLabel_3_4.setBounds(269, 351, 45, 25);
		...
		txtCep.setBounds(292, 387, 138, 25);
		...
		lblNewLabel_3_6.setBounds(439, 197, 94, 25);
		...
		lblNewLabel_3_7.setBounds(439, 233, 88, 25);
		...
		lblNewLabel_3_8.setBounds(439, 268, 88, 25);
		...
		lblNewLabel_3_9.setBounds(439, 304, 88, 25);
		...
		lblNewLabel_3_10.setBounds(434, 340, 149, 25);
		getContentPane().add(lblNewLabel_3_10);

		txtEndereco = new JTextField();
		txtEndereco.setColumns(10);
		txtEndereco.setBounds(638, 195, 220, 29);
		getContentPane().add(txtEndereco);

		txtNumero = new JTextField();
		txtNumero.setColumns(10);
		txtNumero.setBounds(638, 235, 220, 26);
		getContentPane().add(txtNumero);

		txtCidade = new JTextField();
		txtCidade.setColumns(10);
		txtCidade.setBounds(638, 268, 220, 25);
		getContentPane().add(txtCidade);

		txtBairro = new JTextField();
		txtBairro.setColumns(10);
		txtBairro.setBounds(638, 304, 220, 25);
		getContentPane().add(txtBairro);

		txtComplemento = new JTextField();
		txtComplemento.setColumns(10);
		txtComplemento.setBounds(638, 340, 220, 25);
		...
		txtPesquisar.setBounds(175, 109, 154, 23);
	...
	private void pesquisarCliente() {
		String read = "select idcli as ID, nome as clientes, fone as Telefone,uf, endereco as Endere�o, numero as Numero, cep as Cep, complemento as Complemento, bairro as Bairro, cidade as Cidade, fone2 as Celular from clientes where nome like ?";
		try {
	...
	private void adicionarCliente(){
		...
		if (txtNome.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo nome", "Atencao", JOptionPane.ERROR_MESSAGE);
			txtNome.requestFocus();
		} else if (txtFoneUm.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Fone", "Atencao", JOptionPane.WARNING_MESSAGE);
			txtFoneUm.requestFocus();
		} else if (txtBairro.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Bairro", "Atencao", JOptionPane.WARNING_MESSAGE);
			txtBairro.requestFocus();
		} else if (txtCidade.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Cidade", "Atencao", JOptionPane.WARNING_MESSAGE);
			txtCidade.requestFocus();
		}else if (cboUf.getSelectedItem().equals("")) {
			JOptionPane.showMessageDialog(null, "Preencha o campo UF", "Atencao", JOptionPane.WARNING_MESSAGE);
		} else if (txtEndereco.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo endere�o", "Atencao", JOptionPane.WARNING_MESSAGE);
			txtEndereco.requestFocus();
		} else if (txtNumero.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Numero", "Atencao", JOptionPane.WARNING_MESSAGE);
			txtNumero.requestFocus();
		} else if (txtCep.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Cep", "Atencao", JOptionPane.WARNING_MESSAGE);
	...
	private void excluirCliente() {
		int confirma = JOptionPane.showConfirmDialog(null, "Confirma a exclusao desse cliente ?", "Atencao!", JOptionPane.YES_NO_OPTION);
		if (confirma == JOptionPane.YES_OPTION) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Exclusao nao concluida /n O cliente possui pedido em aberto", "Atencao!", JOptionPane.WARNING_MESSAGE);
			}
			catch(Exception e) {
				System.out.println(e);
			}
