...
public class Sobre extends JDialog {
	...
	public Sobre() {
		...
		lblNewLabel_1.setBounds(348, 86, 160, 20);
		...
		lblNewLabel_4.setBounds(20, 370, 589, 28);
		getContentPane().add(lblNewLabel_4);
		
		JLabel lblNewLabel_4_1 = new JLabel("Agradecemos a todos os professores, e pelo");
		lblNewLabel_4_1.setFont(new Font("Microsoft JhengHei", Font.ITALIC, 25));
		lblNewLabel_4_1.setBounds(20, 410, 589, 28);
		getContentPane().add(lblNewLabel_4_1);
		
		JLabel lblNewLabel_4_1_1 = new JLabel("Agradecemos a todos os professores, e pelo");
		lblNewLabel_4_1_1.setFont(new Font("Microsoft JhengHei", Font.ITALIC, 25));
		lblNewLabel_4_1_1.setBounds(20, 449, 589, 28);
