...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		txtPesquisar.setBounds(182, 117, 206, 36);
		getContentPane().add(txtPesquisar);
		
		JLabel lblNewLabel_2 = new JLabel("Pesquisar Nome");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_2.setBounds(31, 120, 165, 25);
		...
		cboPerfil.setBounds(599, 288, 231, 36);
		getContentPane().add(cboPerfil);
		
		txtSenha = new JPasswordField();
		txtSenha.setBounds(120, 288, 206, 36);
		getContentPane().add(txtSenha);
		
		JDesktopPane desktopPane = new JDesktopPane();
		desktopPane.setBounds(454, 109, 376, 81);
	...
	private void adicionarUsuario() {
		if (txtUsuario.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Usuario", "Atencao!", JOptionPane.ERROR_MESSAGE);
			txtUsuario.requestFocus();
		} else if(txtSenha.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Senha", "Atencao!", JOptionPane.ERROR_MESSAGE);
			txtSenha.requestFocus();
		} else if(cboPerfil.getSelectedItem().equals("")) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Perfil", "Atencao!", JOptionPane.ERROR_MESSAGE);
			...
			try {
				...
				if(confirma == 1) {
					JOptionPane.showMessageDialog(null, "Usu�rio criado com sucesso", "MENSAGEM", JOptionPane.INFORMATION_MESSAGE);
				}
				con.close();
				limpar();
			} catch (java.sql.SQLIntegrityConstraintViolationException ex) {
				JOptionPane.showMessageDialog(null, "Login ja existente \n Coloque outro login", "Atencao",
	...
	private void editarUsuario() {
		if (txtUsuario.getText().isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "Preencha o campo Senhs", "Atencao", JOptionPane.ERROR_MESSAGE);
			txtSenha.requestFocus();
		}else if (cboPerfil.getSelectedItem().equals("")) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Perfil", "Atencao", JOptionPane.ERROR_MESSAGE);
			cboPerfil.requestFocus();
			...
			try {
				...
				int confirma = pst.executeUpdate();
				if(confirma == 1) {
					JOptionPane.showMessageDialog(null, "Usuario editado com sucesso", "MENSAGEM", JOptionPane.INFORMATION_MESSAGE);
				}
				con.close();
				limpar();
			} catch (Exception e) {
	...
	private void editarUsuarioPersonalizado() {
		if(txtUsuario.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Usu�rio", "Atencao", JOptionPane.ERROR_MESSAGE);
			txtUsuario.requestFocus();
		} else if (cboPerfil.getSelectedItem().equals("")) {
			JOptionPane.showMessageDialog(null, "Preencha o campo Perfil", "Atencao", JOptionPane.ERROR_MESSAGE);
			cboPerfil.requestFocus();
			...
			try {
				...
				int confirma = pst.executeUpdate();
				if(confirma == 1) {
					JOptionPane.showMessageDialog(null, "Usuario editado com sucesso", "Atencao", JOptionPane.INFORMATION_MESSAGE);
				}
				con.close();
				limpar();
			} catch (Exception e) {
	...
	private void excluirUsuario(){
		int confirma = JOptionPane.showConfirmDialog(null, "Deseja excluir esse usuario ?", "Atencao", JOptionPane.YES_NO_OPTION);
